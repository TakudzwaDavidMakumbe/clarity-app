            ...
            {showModal && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex justify-center items-center px-4">
                    ...
                    <form action={updateWatch} onSubmit={() => setShowModal(false)} className="mt-4">
                        ...
                        />
                        <div className="mb-4">
                            <label htmlFor="brand" className="block text-gray-300 mb-2">Client Full Name</label>
                            <input 
                                type="text" 
                                id="brand"
                                name="brand" 
                        ...
                        <div className="mb-4">
                            <label htmlFor="model" className="block text-gray-300 mb-2">Contact Details</label>
                            <input 
                                type="text" 
                                id="model"
                                name="model" 
                        ...
                        <div className="mb-4">
                            <label htmlFor="referenceNumber" className="block text-gray-300 mb-2">Project Details</label>
                            <input 
                                type="text" 
                                id="referenceNumber"
